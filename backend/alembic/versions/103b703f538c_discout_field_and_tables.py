...
down_revision: Union[str, Sequence[str], None] = "4bcedc987d02"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "required_business_types", postgresql.ARRAY(sa.String()), nullable=True
        ),
    ...
    op.create_index(
        "ix_pricing_configs_is_active_from_to",
        "pricing_configs",
    ...
    op.add_column(
        "itineraries", sa.Column("applied_discount_id", sa.Integer(), nullable=True)
    )
    op.add_column(
        "itineraries",
    ...
    op.add_column(
        "bookings", sa.Column("service_fee_percent", sa.Numeric(), nullable=True)
    )
    op.add_column(
        "bookings", sa.Column("service_fee_amount", sa.Numeric(), nullable=True)
    )
    op.add_column(
        "bookings", sa.Column("discount_percent", sa.Numeric(), nullable=True)
    )
